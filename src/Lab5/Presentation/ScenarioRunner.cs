...
public class ScenarioRunner
{
    ...
    public void Run()
    {
        ...
        SelectionPrompt<IScenario> selector = new SelectionPrompt<IScenario>().Title("Select action")
            .AddChoices(scenarios).UseConverter(x => x.Name);
    ...
    private IEnumerable<IScenario> GetScenarios()
    {
        ...
        {
            if (provider.TryGetScenario(out IScenario? scenario)) yield return scenario;
        }
    }
}